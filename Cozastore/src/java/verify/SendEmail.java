...
public class SendEmail {
    ...
    public void send(String toEmail, String verifyCode) {
        ...
        try {
            ...
            message.setSubject("Here comes The Coza Shop!");
            ...
            message.setContent("<div\n"
                    ...
                    + "      \"\n"
                    + "    >\n"
                    + "    <h1>Here comes the Coza Shop!</h1>\n"
                    ...
                    + "        \"\n"
                    + "      >\n"
                    + "        <a style=\"text-decoration: none\" href=\"http://localhost:9990/CozaShopProject/verify\">Verification link</a>\n"
                    + "      </button>\n"
