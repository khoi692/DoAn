...
public class OrderDetailsController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Purchase o = d.getOrderById(oid);
        LocalDateTime localDateTime = o.getOrderTime();
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
        String formattedDateTime = localDateTime.format(formatter);
        List<OdDetail> oddt = d.getDetailByOrderId(oid);
            request.setAttribute("oddetail", o);
            request.setAttribute("date", formattedDateTime);
            request.setAttribute("oddt", oddt);
