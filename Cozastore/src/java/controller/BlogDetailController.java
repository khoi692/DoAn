...
public class BlogDetailController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getSession().setAttribute("b", b.getBlogById(blogId));
        String[] tagArray = b.getBlogById(blogId).getTag().split("#");
        ArrayList<String> tagList = new ArrayList<>(Arrays.asList(tagArray));
        request.getSession().setAttribute("blogList", b.getAvailableBlogs());
        request.getSession().setAttribute("tagList", tagList);
        request.getSession().setAttribute("cateList", b.getBlogCategories());
        request.getSession().setAttribute("tagListFull", b.getTags());
