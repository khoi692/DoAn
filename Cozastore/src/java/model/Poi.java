...
public class Poi {
    ...
    public static final int COLUMN_INDEX_COST_PRICE = 5;
    public static final int COLUMN_INDEX_SELLING_PRICE  = 6;
   
    private static CellStyle cellStyleFormatNumber = null;
     
 
    public static void writeExcel(List<SizeColorProduct> list, String excelFilePath) throws IOException {
        // Create Workbook
...
//        writeFooter(sheet, rowIndex);
    ...
    private static void writeHeader(Sheet sheet, int rowIndex) {
        ...
        cell = row.createCell(COLUMN_INDEX_COST_PRICE);
        cell.setCellStyle(cellStyle);
        cell.setCellValue("Cost price");
        
        cell = row.createCell(COLUMN_INDEX_SELLING_PRICE);
        cell.setCellStyle(cellStyle);
        cell.setCellValue("Selling price");
    }
 
    // Write data
    private static void writeBook(SizeColorProduct scp, Row row) {
        ProductDAO productDAO = new ProductDAO();
        Product product = productDAO.getProductById(scp.getProductId());
        ...
        cell = row.createCell(COLUMN_INDEX_COLOR);
        cell.setCellValue(scp.getColorId());
 
        cell = row.createCell(COLUMN_INDEX_SIZE);
        cell.setCellValue(scp.getSizeId());
 
        cell = row.createCell(COLUMN_INDEX_QUANTITY);
        cell.setCellValue(scp.getQuantity());
        
        cell = row.createCell(COLUMN_INDEX_COST_PRICE);
        cell.setCellValue(product.getEntryPrice());
...
//    }
    ...
    public static void downloadExcel(HttpServletResponse response) throws IOException {
        final String excelFilePath = "D:\\Ky5\\SWP391\\coza\\cozastore\\Cozastore\\web\\excel\\product.xlsx";
        SizeColorProductDAO scpDAO = new SizeColorProductDAO();
        List<SizeColorProduct> list = scpDAO.getAll();
