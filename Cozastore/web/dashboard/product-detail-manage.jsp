                            ...
                            <div class="col-lg-12">
                                <div class="container">
                                    <form action="updateproduct" method="post" enctype="multipart/form-data">
                                        <input value="${requestScope.productId}" name="productId" hidden/>
                                        <!-- basic information -->
                                        <div class="product-detail">
                                            ...
                                            <div class="d-flex product-input">
                                                ...
                                                <div class="product-detail-input">
                                                    <input type="text" name="productName" placeholder="Input Product Name" value="${requestScope.productName}" required/>
                                                </div>
                                            </div>
                                            <div class="d-flex product-input">
                                                <div class="product-detail-title">
                                            ...
                                            <div class="d-flex product-input">
                                                ...
                                                <div class="product-detail-input">
                                                    <input type="text" name="costPrice" value="${requestScope.costPrice}" required/>
                                                </div>
                                            </div>
                                            <div class="d-flex product-input">
                                                <div class="product-detail-title">
                                                ...
                                                <div class="product-detail-input">
                                                    <input type="text" name="sellingPrice" value="${requestScope.sellingPrice}" required/>
                                                </div>
                                            </div>
                                            <div class="d-flex product-input">
                                                ...
                                                <div class="product-detail-input">
                                                    <textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" name="describe" placeholder="Write Describe" required>${requestScope.describe}</textarea>
                                                </div>
                                            </div>
                                            <div class="d-flex product-input">
                                                <div class="product-detail-title">
                                                ...
                                                <div class="product-detail-input">
                                                    <input type="text" name="discount" value="${requestScope.discount}" required/>
                                                </div>
                                            </div>
                                            <div class="form-group d-flex product-input" id="simple-date4">
                                                ...
                                                <div class="input-daterange product-detail-date  discount">
                                                    <input type="text" class="input-sm form-control" name="startDate" value="${requestScope.discount == 0 ? "":requestScope.startDiscount}"/>
                                                    <span style="padding: 5px;"> to </span>
                                                    <input type="text" class="input-sm form-control" name="endDate" value="${requestScope.discount == 0 ? "":requestScope.endDiscount}"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-detail" >
                                            <div id="allRecord" >
                                                ...
                                                <!-- Record -->
                                                <c:forEach items="${requestScope.productColor}" var="product" >
                                                    <c:set value="0" var="i" />
                                                    <c:set value="${product.colorId}" var="colorProduct"/>
                                                    <c:set var="listSize" value="${product.size}" />
                                                    <c:set var="listQuantity" value="${product.quantity}"/>
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <div class="scp-detail">
                                                                <div class="form-group" id="color">
                                                                    <select class="select2-single-placeholder form-control select2SinglePlaceholder" onchange="changeValueDefault(this)" name="color" >
                                                                        <c:forEach items="${requestScope.colors}" var="color">
                                                                            <option value="${color}" ${colorProduct == color ? "selected":""} >${color}</option>
                                                                        </c:forEach>
                                                                    </select>
                                                            ...
                                                            <div class="size-input">
                                                                <c:forEach items="${requestScope.sizes}" var="size">
                                                                    <div class="size-input-detail">
                                                                        <c:if test="${not empty listSize and listSize.contains(size)}">
                                                                            <c:set var="quantity" value="${listQuantity[i]}"/>
                                                                            <div>
                                                                            ...
                                                                            <input type="text" class="border1 slide2 input-quantity myInput" pattern="[0-9]+" 
                                                                                   ...
                                                                                   id="numberInput" name="quantity" value="${quantity}" />
                                                                            <c:set var="i" value="${i + 1}" />
                                                                        </c:if>
                                                                        <c:if test="${ empty listSize or not listSize.contains(size)}">
                                                                            <div>
                                                                                <input onchange="log(this)" class="checkbox" type="checkbox" name="size" value="${size}"/><span class="size-title">${size}</span>
                                                                            </div>
                                                                            <input type="text" class="border1 slide2 input-quantity myInput" pattern="[0-9]+" 
                                                                                   placeholder="Enter quantity" 
                                                                                   title="Quantity must be natural number." 
                                                                                   id="numberInput" name="quantity"  value="" />
                                                                        </c:if>
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="img-default">
                                                                <input onchange="checkedImage(this)" type="checkbox"
                                                                       value="${colorProduct}" name="defaultImage"  class="checkedImage" ${product.defaultImage == true ? "checked":""}/><span style="margin-left: 6px;">Default Image</span>
                                                            </div>
                                                            <div class="image">
                                                                <input type="file" name="image" class="file-input" accept="image/*" hidden>
                                                                <div class="img-area active" data-img="Choose another Image">
